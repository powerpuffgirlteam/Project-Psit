""" Statistics delays of trains Thailand Project
    This program shows chart of September month 2016 that show statistics average delays of trains Thailand divided by route
"""
import pygal
def make_chart():
    """This function use to make chart of September month 2016 that show statistics average delays
    of trains Thailand divided by route"""
    from pygal.style import NeonStyle
    chart = pygal.StackedLine(fill=True, interpolate='cubic', style=NeonStyle)
    line_chart = pygal.StackedLine(fill=True)
    line_chart.title = 'Statistics average delays of trains Thailand divided by route of September month 2016'
